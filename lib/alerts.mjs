 ...
 */
export function renderBrandedEmail({ eyebrow, title, bodyText = "", ctaUrl, ctaLabel, variant = "user" }) {
  ...
  return `<!doctype html><html lang="en"><body style="margin:0;padding:0;background:${PAPER};-webkit-text-size-adjust:100%">
    ...
    <tr><td align="center">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:${CARD};border:1px solid ${BORDER};border-radius:14px;overflow:hidden">
        ...
        <tr><td style="padding:28px 36px 0">
          <div style="font:700 22px/1 ${SERIF};letter-spacing:.32em;color:${INK}">M&#298;ZAN</div>
          <div style="font:italic 400 12px/1.4 ${SERIF};color:${MUTED};margin-top:7px">Balance your wealth. Honor your deen.</div>
        </td></tr>
