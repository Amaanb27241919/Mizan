...
> Last audited: 2026-07-03 (updated) · All findings from direct file reads, no guessing.
>
...
23 migrations — all sequential (011 gap was patched). Bot tables (020–022) added in the 2026-06-24/25 sessions; `023_bot_strategy_type_dca` (allows `strategy_type='dca'`) added 2026-06-30:
